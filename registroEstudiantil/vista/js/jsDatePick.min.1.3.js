...
g_l.MONTH_BCK="Mover un mes hacia atras";
g_l.YEAR_FWD="Mover un año hacia adelante";
g_l.YEAR_BCK="Mover un año hacia atras";
g_l.CLOSE="Cerrar el calendario";
g_l.ERROR_2=g_l.ERROR_1="¡Fecha invalida!";
g_l.ERROR_4=g_l.ERROR_3="Objetivo invalido";
    ...
    if(this.lastPickedDateObject){
        ...
        if(b.value.trim().length==0){
            ...
            if(b.value.trim().length>5){
                ...
                this.setSelectedDay({
                    year:parseInt(g[h],10),month:k,day:parseInt(g[a],10)
                })
            }
            else{
                this.unsetSelection();
